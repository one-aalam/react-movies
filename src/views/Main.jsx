...
const Main = React.createClass({
	...
	loadStargazersFn (untilAllLoaded, currentPage, completedFn) {
		Superagent.get(
			`https://api.github.com/repos/RickWong/react-isomorphic-starterkit/stargazers?per_page=20&page=${currentPage}`
		).
		end((error, response) => {
	...
	render() {
		...
		return (
			<InlineCss stylesheet={Main.css(avatarSize)} namespace="Main">
				...
				<h3>Features - customised for personal use</h3>
				<ul>
					<li>Fully automated with npm run scripts and styles</li>
				...
				<p>
					In short – <em>This is an excellent choice</em>.
					Ready to start{'?'}
				</p>
				<h3>Communityx</h3>
				<p>
